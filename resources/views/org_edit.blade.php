...
@section('content')
    ...
    <div class="container-fluid container-fullw bg-white">
        <div class="row">
            ...
            {!! Form::open(['url' => route('orgEdit',['id'=>$data['id']]),'class'=>'form-horizontal','method'=>'POST', 'id'=>'form_org']) !!}
            ...
            <div class="form-group">
                ...
                <div class="col-xs-8">
                    {!! Form::text('title',$data['title'],['class' => 'form-control','placeholder'=>'Введите полное название организации','maxlength'=>'150','required'=>'required'])!!}
            ...
            <div class="form-group">
                ...
                <div class="col-xs-8">
                    {!! Form::select('org_form_id',$orgsel, $data['org_form_id'], ['class' => 'form-control','required'=>'required']); !!}
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-xs-8">
                    {!! Form::text('print_name',$data['print_name'],['class' => 'form-control','placeholder'=>'Введите название для документов','maxlength'=>'150'])!!}
            ...
            <div class="form-group">
                ...
                <div class="col-xs-8">
                    {!! Form::text('short_name',$data['short_name'],['class' => 'form-control','placeholder'=>'Введите короткое название','maxlength'=>'100'])!!}
            ...
            <div class="form-group">
                ...
                <div class="col-xs-8">
                    {!! Form::text('inn',$data['inn'],['class' => 'form-control','placeholder'=>'Укажите ИНН','maxlength'=>'12'])!!}
            ...
            <div class="form-group">
                ...
                <div class="col-xs-8">
                    {!! Form::text('kpp',$data['kpp'],['class' => 'form-control','placeholder'=>'Укажите КПП','maxlength'=>'9'])!!}
            ...
            <div class="form-group">
                ...
                <div class="col-xs-8">
                    {!! Form::text('ogrn',$data['ogrn'],['class' => 'form-control','placeholder'=>'Укажите ОГРН','maxlength'=>'15'])!!}
            ...
            <div class="form-group">
                ...
                <div class="col-xs-8">
                    {!! Form::select('status',['0'=>'Не активная','1'=>'Активная'], $data['status'], ['class' => 'form-control','required'=>'required']); !!}
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-xs-8">
                    {!! Form::text('prefix',$data['prefix'],['class' => 'form-control','placeholder'=>'Укажите префикс для документов','maxlength'=>'10'])!!}
            ...
            <div class="form-group">
                ...
                <div class="col-xs-8">
                    {!! Form::text('account',$data['account'],['class' => 'form-control','placeholder'=>'Введите расчетный счет','maxlength'=>'25'])!!}
            ...
            <div class="form-group">
                ...
                <div class="col-xs-8">
                    {!! Form::text('legal_address',$data['legal_address'],['class' => 'form-control','placeholder'=>'Укажите юридический адрес','maxlength'=>'255'])!!}
            ...
            <div class="form-group">
                ...
                <div class="col-xs-8">
                    {!! Form::text('post_address',$data['post_address'],['class' => 'form-control','placeholder'=>'Укажите почтовый адрес','maxlength'=>'255'])!!}
            ...
            <div class="form-group">
                ...
                <div class="col-xs-8">
                    {!! Form::text('phone',$data['phone'],['class' => 'form-control input-mask-phone','placeholder'=>'Укажите телефон','maxlength'=>'20'])!!}
            ...
            <div class="form-group">
                ...
                <div class="col-xs-8">
                    {!! Form::email('e-mail',$data['e-mail'],['class' => 'form-control','placeholder'=>'Укажите e-mail','maxlength'=>'30'])!!}
