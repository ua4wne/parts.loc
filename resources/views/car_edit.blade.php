...
@section('content')
    ...
    <ul class="breadcrumb">
        ...
        <li><a href="{{ route('cars') }}">{{ $title }}</a></li>
    ...
    <div class="container-fluid container-fullw bg-white">
        <div class="row">
            ...
            {!! Form::open(['url' => route('carEdit',['id'=>$data['id']]),'class'=>'form-horizontal','method'=>'POST', 'id'=>'form_ref']) !!}
            ...
            <div class="form-group">
                ...
                <div class="col-xs-8">
                    {!! Form::text('title',$data['title'],['class' => 'form-control','placeholder'=>'Наименование ТС','maxlength'=>'150','required'=>'required'])!!}
            ...
            <div class="form-group">
                ...
                <div class="col-xs-8">
                    {!! Form::textarea('descr',$data['descr'],['class'=>'form-control', 'rows' => 2, 'cols' => 50,'maxlength'=>'254']) !!}
