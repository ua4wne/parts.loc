...
@section('content')
    ...
    <div class="container-fluid container-fullw bg-white">
        <div class="row">
            ...
            {!! Form::open(['url' => route('carAdd'),'class'=>'form-horizontal','method'=>'POST', 'id'=>'form_ref']) !!}
            ...
            <div class="form-group">
                ...
                <div class="col-xs-8">
                    {!! Form::text('title',old('title'),['class' => 'form-control','placeholder'=>'Наименование ТС','maxlength'=>'150','required'=>'required'])!!}
            ...
            <div class="form-group">
                ...
                <div class="col-xs-8">
                    {!! Form::textarea('descr',old('descr'),['class'=>'form-control', 'rows' => 2, 'cols' => 50,'maxlength'=>'254']) !!}
