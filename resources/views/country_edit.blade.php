...
@section('content')
    ...
    <div class="container-fluid container-fullw bg-white">
        <div class="row">
            ...
            {!! Form::open(['url' => route('countryEdit',['id'=>$data['id']]),'class'=>'form-horizontal','method'=>'POST', 'id'=>'form_ref']) !!}
            ...
            <div class="form-group">
                ...
                <div class="col-xs-8">
                    {!! Form::text('code1',$data['code1'],['class' => 'form-control','placeholder'=>'Введите код страны','maxlength'=>'5','required'=>'required'])!!}
            ...
            <div class="form-group">
                ...
                <div class="col-xs-8">
                    {!! Form::text('code2',$data['code2'],['class' => 'form-control','placeholder'=>'','maxlength'=>'5'])!!}
            ...
            <div class="form-group">
                ...
                <div class="col-xs-8">
                    {!! Form::text('code3',$data['code3'],['class' => 'form-control','placeholder'=>'','maxlength'=>'5'])!!}
            ...
            <div class="form-group">
                ...
                <div class="col-xs-8">
                    {!! Form::select('eaes',['0'=>'Нет', '1'=>'Да'], $data['eaes'], ['class' => 'form-control','required'=>'required']); !!}
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-xs-8">
                    {!! Form::text('full_name',$data['full_name'],['class' => 'form-control','placeholder'=>'Введите полное наименование страны','maxlength'=>'70'])!!}
