...
@section('content')
    ...
    <ul class="breadcrumb">
        ...
        <li class="active"><a href="/specifications/view/{{ $data['good_id'] }}">{{ $title }}</a></li>
    ...
    <div class="container-fluid container-fullw bg-white">
        <div class="row">
            ...
            <div class="form-group">
                ...
                <div class="col-xs-8">
                    {!! Form::select('brand_id',$bsel, $data['brand_id'],['class' => 'select2 form-control','maxlength'=>'7','required'=>'required'])!!}
