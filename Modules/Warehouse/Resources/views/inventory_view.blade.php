...
@section('content')
    ...
    <ul class="breadcrumb">
        ...
        <li class="active"><a href="{{ route('inventoryView',['id'=>$id]) }}">{{ $head }}</a></li>
    </ul>
    <!-- END BREADCRUMB -->
    <!-- page content -->
                ...
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                <label class="col-xs-3 control-label">
                                    Цена, руб: <span class="symbol required" aria-required="true"></span>
                                </label>
                                <div class="col-xs-8">
                                    {!! Form::text('price',old('price'),['class' => 'form-control','placeholder'=>'Укажите цену за единицу товара','required'=>'required','id'=>'price'])!!}
                                </div>
                            </div>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-xs-8">
                                    {!! Form::text('price',old('price'),['class' => 'form-control','placeholder'=>'Укажите цену за единицу товара','required'=>'required','id'=>'eprice'])!!}
                                </div>
                            </div>
