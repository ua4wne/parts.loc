...
@section('content')
    ...
    <div class="container-fluid container-fullw bg-white">
        <div class="row">
            ...
            {!! Form::open(['url' => route('wh_correctsAdd'),'class'=>'form-horizontal','method'=>'POST', 'id'=>'form_new']) !!}
            ...
            <div class="form-group">
                ...
                <div class="col-xs-8">
                    {!! Form::select('price_id',$psel, old('price_id'), ['class' => 'form-control','required'=>'required']); !!}
                </div>
            </div>
