...
@section('content')
    ...
    <div class="container-fluid container-fullw bg-white">
        <div class="row">
            ...
            {!! Form::open(['url' => route('brandAdd'),'class'=>'form-horizontal','method'=>'POST', 'id'=>'form_wx']) !!}
            ...
            <div class="form-group">
                ...
                <div class="col-xs-8">
                    {!! Form::text('full_name',old('full_name'),['class' => 'form-control','placeholder'=>'Введите описание','maxlength'=>'100'])!!}
