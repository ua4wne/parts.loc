...
@section('content')
    ...
    <div class="container-fluid container-fullw bg-white">
        <div class="row">
            ...
            {!! Form::open(['url' => route('wh_correctEdit',['id'=>$data['id']]),'class'=>'form-horizontal','method'=>'POST', 'id'=>'form_new']) !!}
            ...
            <div class="form-group">
                ...
                <div class="col-xs-8">
                    {!! Form::text('reason',$data['reason'],['class' => 'form-control','placeholder'=>'Укажите основание для инвентаризации','maxlength'=>'150'])!!}
            ...
            <div class="form-group">
                ...
                <div class="col-xs-8">
                    {!! Form::select('user_id',$usel, $data['user_id'], ['class' => 'form-control','required'=>'required']); !!}
                </div>
            </div>
