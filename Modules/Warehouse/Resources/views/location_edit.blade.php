...
@section('content')
    ...
    <div class="container-fluid container-fullw bg-white">
        <div class="row">
            ...
            {!! Form::open(['url' => route('locationEdit',['id'=>$data['id']]),'class'=>'form-horizontal','method'=>'POST', 'id'=>'form_wx']) !!}

            <div class="form-group">
                {!! Form::label('barcode','Штрих-код:',['class' => 'col-xs-3 control-label'])   !!}
                <div class="col-xs-8">
                    {!! Form::text('barcode',$data['barcode'],['class' => 'form-control','placeholder'=>'Введите штрихкод','maxlength'=>'32'])!!}
            ...
            <div class="form-group">
                ...
                <div class="col-xs-8">
                    {!! Form::select('warehouse_id',$whsel, $data['warehouse_id'], ['class' => 'form-control','required'=>'required']); !!}
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-xs-8">
                    {!! Form::text('length',$data['length'],['class' => 'form-control','placeholder'=>'Укажите длину','maxlength'=>'7'])!!}
            ...
            <div class="form-group">
                ...
                <div class="col-xs-8">
                    {!! Form::text('widht',$data['widht'],['class' => 'form-control','placeholder'=>'Укажите ширину','maxlength'=>'7'])!!}
            ...
            <div class="form-group">
                ...
                <div class="col-xs-8">
                    {!! Form::text('height',$data['height'],['class' => 'form-control','placeholder'=>'Укажите высоту','maxlength'=>'7'])!!}
            ...
            <div class="form-group">
                ...
                <div class="col-xs-8">
                    {!! Form::text('capacity',$data['capacity'],['class' => 'form-control','placeholder'=>'Укажите емкость (кратно европаллетам)',
            ...
            <div class="form-group">
                ...
                <div class="col-xs-8">
                    {!! Form::number('priority',$data['priority'],['class' => 'form-control','placeholder'=>'Введите число','min' => 0, 'max' => 250,'required'=>'required'])!!}
            ...
            <div class="form-group">
                ...
                <div class="col-xs-8">
                    {!! Form::select('in_lock',['0'=>'Нет', '1'=>'Да'], $data['in_lock'], ['class' => 'form-control','required'=>'required']); !!}
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-xs-8">
                    {!! Form::select('out_lock',['0'=>'Нет', '1'=>'Да'], $data['out_lock'], ['class' => 'form-control','required'=>'required']); !!}
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-xs-8">
                    {!! Form::select('is_assembly',['0'=>'Нет', '1'=>'Да'], $data['is_assembly'], ['class' => 'form-control','required'=>'required']); !!}
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-xs-8">
                    {!! Form::select('is_shipment',['0'=>'Нет', '1'=>'Да'], $data['is_shipment'], ['class' => 'form-control','required'=>'required']); !!}
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-xs-8">
                    {!! Form::select('is_acceptance',['0'=>'Нет', '1'=>'Да'], $data['is_acceptance'], ['class' => 'form-control','required'=>'required']); !!}
                </div>
            </div>
