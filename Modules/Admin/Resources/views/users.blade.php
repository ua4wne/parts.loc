...
@section('content')
    ...
    <div class="container-fluid container-fullw bg-white">
        <div class="row">
            ...
            <div class="modal fade" id="roleUser" tabindex="-1" role="dialog" aria-labelledby="roleUser"
                 aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                    ...
                    <div class=" table-responsive">
                        <table id="datatable" class="table table-hover table-bordered">
                            ...
                            @foreach($users as $k => $user)
                                ...
                                <tr>
                                    @if($user->image)
                                        <td style="width:32px;"><img src="{{ $user->image }}" alt="..."
                                                                     class="img-responsive center-block"></td>
                                    @else
                                        <td style="width:32px;"><img src="/images/default-user.png" alt="..."
                                                                     class="img-responsive center-block"></td>
                                    @endif
                                    <th>{{ $user->name }}</th>
                                    <td>{{ $user->email }}</td>
                                    ...
                                    @if($user->active)
                                        <td><span role="button" class="label label-success"
                                                  id="{{ $user->id }}">Активен</span></td>
                                    @else
                                        <td><span role="button" class="label label-danger" id="{{ $user->id }}">Не активен</span>
                                        </td>
                                    @endif
                                    @if($user->id==1)
                                        <td style="width:150px;">
                                            <div class="form-group" role="group">
                                                <button class="btn btn-info btn-sm login_role" type="button"
                                                        data-toggle="modal" data-target="#roleUser"
                                                        title="Установить роли"><i class="fa fa-users fa-lg"
                                                                                   aria-hidden="true"></i></button>
                                                <button class="btn btn-success btn-sm login_edit" type="button"
                                    ...
                                    @else
                                        <td style="width:200px;">
                                            <div class="form-group" role="group">
                                                ...
                                                <a href="{{ route('userReset',['id'=>$user->id]) }}"
                                                   class="btn btn-warning btn-sm" type="button" title="Сбросить пароль"><i
                                                        class="fa fa-recycle fa-lg" aria-hidden="true"></i></a>
                                                <button class="btn btn-danger btn-sm login_delete" type="button"
