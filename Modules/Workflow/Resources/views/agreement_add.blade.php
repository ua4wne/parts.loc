...
@section('content')
    ...
    <div class="container-fluid container-fullw bg-white">
        <div class="row">
            ...
            {!! Form::open(['url' => route('agreementAdd'),'class'=>'form-horizontal','method'=>'POST', 'id'=>'form_ref']) !!}
            ...
            <div class="form-group">
                ...
                <div class="col-xs-8">
                    {!! Form::text('doc_num',old('doc_num'),['class' => 'form-control','placeholder'=>'Введите номер','maxlength'=>'15','required'=>'required'])!!}
            ...
            <div class="form-group">
                ...
                <div class="col-xs-8">
                    {{ Form::date('finish', old('finish'),['class' => 'form-control']) }}
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-xs-8">
                    {!! Form::select('currency_id',$cursel, old('currency_id'), ['class' => 'form-control','required'=>'required']); !!}
                </div>
            </div>
