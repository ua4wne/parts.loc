                            ...
                            @foreach($rows as $k => $row)
                                <tr {!! $row->statuse->style !!} }>
                                    ...
                                    <td style="width:100px;">
                                        {!! Form::open(['url'=>route('purchaseDelete'), 'class'=>'form-inline','method' => 'POST', 'onsubmit' => 'return confirmDelete()']) !!}
                                        {!! Form::hidden('purchase_id',$row->id,['class' => 'form-control','required'=>'required','id'=>'purchase_id']) !!}
                                        <div class="form-group" role="group">
                                            <a href="{{route('purchaseView',['id'=>$row->id])}}">
