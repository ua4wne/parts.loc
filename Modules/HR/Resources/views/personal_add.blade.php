...
@section('content')
    ...
    <div class="container-fluid container-fullw bg-white">
        <div class="row">
            ...
            {!! Form::open(['url' => route('personalAdd'),'class'=>'form-horizontal','method'=>'POST']) !!}
            ...
            <div class="form-group">
                ...
                <div class="col-xs-8">
                    {!! Form::select('position_id',$possel, old('position_id'), ['class' => 'form-control','required'=>'required']); !!}
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-xs-8">
                    {!! Form::select('signing',['0'=>'Нет права подписи','1'=>'Есть право подписи'], old('signing'), ['class' => 'form-control','required'=>'required']); !!}
                </div>
            </div>
